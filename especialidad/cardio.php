...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/reservas/css/cardio.css">
</head>
<body>
            ...
            <ul class="menu__links">
                ...
                <li class="menu__item menu__item--show">
                    ...
                    <ul class="menu__nesting">
                        ...
                        <li class="menu__inside">
                            <a href="http://localhost/reservas/reservas/especialidad/cardio.php" class="menu__link menu__link--inside">Cirujia</a>
                        </li>
                        <li class="menu__inside">
                            <a href="http://localhost/reservas/especialidad/cardio.php" class="menu__link menu__link--inside">Medicina Felina</a>
                        </li>
                        <li class="menu__inside">
